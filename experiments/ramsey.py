...
if maybe_run_chunked_mode(
    ...
    combine_filename="ramsey_fine_res_combined.h5",
...
if PLOT_DEBUG_RAW:
    plot_debug_traces(
        ...
        title=build_standard_title(
            experiment_label="Ramsey Debug Raw",
            sequence_label=r"$\pi/2 - \tau - \pi/2$",
            run_id=run_id,
        ),
        metadata=metadata,
